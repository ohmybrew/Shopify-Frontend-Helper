...
var Checkout = /** @class */ (function (_super) {
   ...
   */
    Checkout.verifyDiscount = function (discount) {
        return __awaiter(this, void 0, void 0, function () {
            var response, parser, htmlDoc, htmlQs, htmlQsa, discountCode, discountAmount, discountType, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        htmlQs = function (query, target) {
                            if (target === void 0) { target = htmlDoc; }
                            return target.querySelector(query);
                        };
                        htmlQsa = function (query, target) {
                            if (target === void 0) { target = htmlDoc; }
                        ...
                        if (response.indexOf('data-discount-success') > -1) {
                            ...
                            discountAmount = __spread(htmlQsa('.order-summary .reduction-code .reduction-code__text')).reduce(function (acc, node) {
                                var match = node.innerHTML.match(/\(\-\$([0-9.,]+)\)/);
